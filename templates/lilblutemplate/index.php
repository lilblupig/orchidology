...
/**
 * @package     Joomla.Site
 * @subpackage  Templates.LilbluTemplate
 *
...
$wa->useStyle('template.lilblutemplate.mainstyles');
$wa->useStyle('template.lilblutemplate.user');
$wa->useScript('template.lilblutemplate.scripts');
